											...
											<div class="btns-group grid-x grid-padding-x align-center">
												<?php 
													...
													<div class="cell shrink">
														<a class="button align-center<?php if( $has_icon === true ):?> has-icon<?php endif;?>" href="<?php echo esc_url( $link_url ); ?>" target="<?php echo esc_attr( $link_target ); ?>">
												...
												<?php 
													...
													?>
													<div class="cell shrink">
														<a class="button align-center" href="<?php echo esc_url( $link_url ); ?>" target="<?php echo esc_attr( $link_target ); ?>"><?php echo esc_html( $link_title ); ?></a>
													</div>
												<?php endif; ?>
											</div>
										</div>
